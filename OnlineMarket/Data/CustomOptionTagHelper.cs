...
namespace OnlineMarket.Data.Extensions
{
    ...
    public class CustomOptionTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (formDataEntry != null)
            {
                ...
                //selectedValues = (formDataEntry.Ad<CurrentValues>()).Values;
        ...
        {
            if (string.Equals(this.EntityName, "AdminModel", StringComparison.OrdinalIgnoreCase))
                return _adminRepository.GetAllAsync().Result.Select(r => new SelectListItem() { Value = r.Id.ToString(), Text = r.Username });
            else
                return null;
        }
    }
