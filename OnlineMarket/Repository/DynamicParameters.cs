...
namespace Dapper
{
    ...
    public partial class DynamicParameters : SqlMapper.IDynamicParameters, SqlMapper.IParameterLookup, SqlMapper.IParameterCallbacks
    {
        ...
        {
            //var literals = SqlMapper.GetTypeName(identity.sql);
...
#pragma warning disable 618
                    dbType = (DbType)SqlMapper.LookupDbType(val.GetType(), name, true, out handler);
#pragma warning disable 618
                }
...
#pragma warning restore 0618
                        ...
                        if (param.Size != null) p.Size = param.Size;
            ...
            //if (literals) SqlMapper.ReplaceLiterals(this, command, literals);
        }
...
#pragma warning restore IDE0019 // use pattern matching
            ...
            var setter = (Action<object, DynamicParameters>)cache;
